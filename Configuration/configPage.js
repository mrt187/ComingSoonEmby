define(["emby-input", "emby-button", "emby-checkbox", "emby-select"], function () {
    ...
    var text = {
        English: {
            ...
            releaseRegionDescription: "Uses TMDB dates for this country. Movies without the selected regional date are omitted. Radarr is only used when regional lookup is unavailable.",
            ...
            tmdbApiKeyDescription: "Enables country-specific movie dates and local trailer downloads. Without it, movie dates fall back to Radarr. With it, movies missing the selected regional date are omitted. Free key at themoviedb.org/settings/api.",
        ...
        German: {
            ...
            releaseRegionDescription: "Verwendet TMDB-Termine für dieses Land. Filme ohne den ausgewählten regionalen Termin werden ausgelassen. Radarr wird nur verwendet, wenn die regionale Abfrage nicht verfügbar ist.",
            ...
            tmdbApiKeyDescription: "Aktiviert länderspezifische Filmtermine und lokale Trailer-Downloads. Ohne Schlüssel werden Radarr-Termine verwendet. Mit Schlüssel werden Filme ohne den ausgewählten regionalen Termin ausgelassen. Kostenloser Schlüssel unter themoviedb.org/settings/api.",
